    ...
    <nav className="fixed top-0 left-0 right-0 z-50 glass">
      ...
      <div className="container mx-auto flex h-16 items-center justify-between px-6">
        ...
        <button
          ...
          className="inline-flex items-center justify-center rounded-full border border-primary/40 bg-primary/10 p-2 text-primary transition hover:bg-primary/20 md:hidden"
