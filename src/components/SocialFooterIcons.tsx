...
const iconWrap =
  "flex h-9 w-9 items-center justify-center rounded-full border border-border/80 bg-background/40 text-muted-foreground transition hover:border-primary/45 hover:text-primary hover:shadow-[0_0_18px_-6px_hsl(var(--primary)/0.45)]";
...
export const socialFooterIconClass = iconWrap;
